<?php
$titre="Petite liste exhaustive (ou pas) des expressions de M Lachal";
include('menu.php');

$Rub_Pedagogie="Je répète toujours les mêmes choses, mais c'est mon métier : bis repetita placent !
...
Merci d'avoir joué avec nous, en espérant que vous reviendrez une prochaine fois... [À quelqu'un qui en a sorti une monumentale]
...
$Rub_Transcendentale = "Cela nous plonge dans une pâmoison extatique voire ataraxique !
...
$Rub_PetitsExos="Un petit exo pour samedi soir au lieu de fréquenter :
...
Afin d'endiguer toute propension à quelque turpitude regrettable, vite un petit exo !
...
$Rub_Eleves="Irrévérence ostentatoire voire attentatoire (NDLR : noter les allitérations...) à un agent de la fonction publique dans l'exercice de ces fonctions ? [À quelqu'un qui ironiserait]
...
Diantre, un thaumaturge est parmi nous ! [À quelqu'un qui allume la lumière] Vous marchez aussi sur l'eau ?";

$Rub_Glose="Encore une petite glose ? [À quelqu'un qui se gausse dans son coin]
...
$Rub_Trivialite="Est-ce une tautologie apodictique, ou n'aurait-on pas plutôt affaire à un paralogisme assertorique à tendance captieuse ?
...
$Rub_Floue="C'est d'une abstrusion indicible ! [À quelqu'un qui se livre à des calculs méphistophéliques... faux !]
...
$Rub_Just="Just do it ! [À quelqu'un qui baratine et qui dit qu'on pourrait le faire]
...
$Rub_Snif="Vite, ouvrons la fenêtre afin d'évacuer ces relants de sudations fétides ! [Entrée dans une salle précédemment occupée, la buée dégoulinant des fenêtres...]
...
$Rub_TSCH="Notre thuriféraire à la verve désopilante !
...
?>
<h1>Les expressions idiolectes !</h1>
<p>Vous avez aimé le <a href="index.php">dictionnaire</a> ? Vous allez aduler dans une génuflexion apostolique <span style="text-decoration:line-through;">le 5<sup>ème</sup> degré</span> le dictionnaire des expressions idiomatiques, mis à jour par les même thuriféraires ! <strong>Just enjoy it !</strong></p>

<fieldset class="Liste">
<legend>RUBRIQUE PÉDAGOGIE</legend>
<?php echo nl2br($Rub_Pedagogie); ?>
</fieldset>
<fieldset class="Liste">
<legend>RUBRIQUE TRANSCENDENTALE</legend>
<?php echo nl2br($Rub_Transcendentale); ?>
</fieldset>
<fieldset class="Liste">
<legend>RUBRIQUE PETITS EXOS DU SAMEDI SOIR</legend>
<?php echo nl2br($Rub_PetitsExos); ?>
</fieldset>
<fieldset class="Liste">
<legend>RUBRIQUES ÉLÈVES PÉNIBLES VOIRE INSOLENTS</legend>
<?php echo nl2br($Rub_Eleves); ?>
</fieldset>
<fieldset class="Liste">
<legend>RUBRIQUE GLOSES INTEMPESTIVES</legend>
<?php echo nl2br($Rub_Glose); ?>
</fieldset>
<fieldset class="Liste">
<legend>RUBRIQUE TRIVIALITÉS</legend>
<?php echo nl2br($Rub_Trivialite); ?>
</fieldset>
<fieldset class="Liste">
<legend>RUBRIQUE FLOUE</legend>
<?php echo nl2br($Rub_Floue); ?>
</fieldset>
<fieldset class="Liste">
<legend>RUBRIQUE JUST !</legend>
<?php echo nl2br($Rub_Just); ?>
</fieldset>
<fieldset class="Liste">
<legend>RUBRIQUE ODEUR</legend>
<?php echo nl2br($Rub_Snif); ?>
</fieldset>
<fieldset class="Liste">
<legend>RUBRIQUE TSCHIRHARD [élément exceptionnel de l'assemblée] </legend>
<?php echo nl2br($Rub_TSCH); ?>
</fieldset>
</div>
</body>
</html>
