...
<h3>Sommaire</h3>
<ol>
<li><a href="AuRevoir-51">Adieux &ndash; Promo 51</a></li>
<li><a href="AuRevoir-52">Adieux &ndash; Promo 52</a></li>
<li><a href="AuRevoir-53">Adieux &ndash; Promo 53</a></li>
<li><a href="AuRevoir-54">Adieux &ndash; Promo 54</a></li>
<li><a href="AuRevoir-55">Adieux &ndash; Promo 55</a></li>
</ol>
...
<p><a href="Ressources/LACHAL_au_revoir.pdf">Fichier PDF original</a></p>


<?php
}
elseif(isset($_GET['P-52']))
{?>
<h2 id="P-52">Promo 52</h2>
<p><img src="Pics/AuRevoir/52-Remerciements.jpg" alt="Remerciements de la promo 52" style="width:90%;" /></p>



<?php
}
elseif(isset($_GET['P-53']))
{?>
...
<img src="Pics/AuRevoir/<nolink>Craie</nolink>_2.jpg" alt="T'en veux ???" /><br />
t'en veux ???<br /><br /><br /><br /><br />
...
<p><a href="Ressources/au_revoir2011.pdf">Fichier PDF original</a></p>

<?php
}
elseif(isset($_GET['P-55']))
{?>

<h2 id="P-55">Promo 55</h2>
<div style="font-size:5em; background-color:white; text-align:center; margin:auto; text-transform:uppercase">
<?php
$baseURL = "Ressources/au_revoir2012/";
$files = glob($baseURL . '*.jpg');
...
foreach($files as $file)
{
	echo '<p><img src="' . $baseURL . $file . '" alt="INSA promo 55 -- ' . $file . '" /></p>' . "\n\n";
}?>

</div>
<p><a href="Ressources/au_revoir2012/au_revoir2012.pdf">Fichier PDF original</a></p>

<p><img src="Ressources/au_revoir2012/cadeaux/cadeau1.jpg" alt="Remerciements de la promo 53" style="width:90%;" /></p>
<p><img src="Ressources/au_revoir2012/cadeaux/cadeau2.jpg" alt="Remerciements de la promo 53" style="width:90%;" /></p>
<p><img src="Ressources/au_revoir2012/cadeaux/cadeau3.jpg" alt="Remerciements de la promo 53" style="width:90%;" /></p>
<p><img src="Ressources/au_revoir2012/cadeaux/cadeau4.jpg" alt="Remerciements de la promo 53" style="width:90%;" /></p>
